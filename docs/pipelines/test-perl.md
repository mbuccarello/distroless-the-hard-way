...
# Opensource Distroless E2E Verification: Perl

This pipeline verifies the technical integrity of the [`perl:latest`](assemble-perl.md) image.

## Verification Logic
It executes a Perl script to assert:
- **Runtime Integrity**: Successful execution of the natively compiled Perl binary.
