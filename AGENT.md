...
- **Strict Anti-AI Style:** 
    ...
    - **No Vague Intensifiers:** Do not use adjectives that assert quality without a mechanism to back them up in the same sentence — "high-assurance," "sovereign," "robust," "comprehensive," "seamless," "enterprise-grade," "cutting-edge," "state-of-the-art," "unified," "holistic," "paradigm," and "leverage" (as a verb) are banned unless the sentence also names the specific, checkable thing that makes it true (a flag, a file, a mechanism, a test). "The high-assurance openssl Atom" is banned; "The openssl Atom, pinned to a SHA256 checksum" is not. If deleting the adjective loses no information, delete it.
