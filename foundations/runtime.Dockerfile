...
COPY --from=zlib /artifacts/usr /opt/distroless
COPY --from=gdbm /artifacts/usr /opt/distroless
...
RUN set -ex && curl -L "https://www.cpan.org/src/5.0/perl-5.38.2.tar.gz" -o source.tar.gz && mkdir src && tar -xf source.tar.gz -C src --strip-components=1 && cd src && \
    export CPPFLAGS="-I/opt/distroless/include" && \
    export LDFLAGS="-L/opt/distroless/lib -L/opt/distroless/lib64 -Wl,-rpath,/usr/lib" && \
    export PKG_CONFIG_PATH="/opt/distroless/lib/pkgconfig:/opt/distroless/lib64/pkgconfig" && \
    if [ -f ./Configure ] && grep -q "Perl" ./Configure; then \
        ./Configure -des -Dprefix=/usr -Dvendorprefix=/usr -Dprivlib=/usr/share/perl5/core_perl -Darchlib=/usr/lib/perl5/5.38/core_perl -Dvendorlib=/usr/share/perl5/vendor_perl -Dvendorarch=/usr/lib/perl5/5.38/vendor_perl -Dsitearch=/usr/lib/perl5/5.38/site_perl -Dsitelib=/usr/share/perl5/site_perl -Duseshrplib -Dusethreads -Dlocincpth="/opt/distroless/include" -Dloclibpth="/opt/distroless/lib /opt/distroless/lib64"; \
    elif [ -f ./configure ]; then ./configure --prefix=/usr -des -Dprefix=/usr -Dvendorprefix=/usr -Dprivlib=/usr/share/perl5/core_perl -Darchlib=/usr/lib/perl5/5.38/core_perl -Dvendorlib=/usr/share/perl5/vendor_perl -Dvendorarch=/usr/lib/perl5/5.38/vendor_perl -Dsitearch=/usr/lib/perl5/5.38/site_perl -Dsitelib=/usr/share/perl5/site_perl -Duseshrplib -Dusethreads; elif [ -f ./Configure ]; then ./Configure -des -Dprefix=/usr -Dvendorprefix=/usr -Dprivlib=/usr/share/perl5/core_perl -Darchlib=/usr/lib/perl5/5.38/core_perl -Dvendorlib=/usr/share/perl5/vendor_perl -Dvendorarch=/usr/lib/perl5/5.38/vendor_perl -Dsitearch=/usr/lib/perl5/5.38/site_perl -Dsitelib=/usr/share/perl5/site_perl -Duseshrplib -Dusethreads; elif [ -f ./CMakeLists.txt ]; then cmake -DCMAKE_INSTALL_PREFIX=/usr -des -Dprefix=/usr -Dvendorprefix=/usr -Dprivlib=/usr/share/perl5/core_perl -Darchlib=/usr/lib/perl5/5.38/core_perl -Dvendorlib=/usr/share/perl5/vendor_perl -Dvendorarch=/usr/lib/perl5/5.38/vendor_perl -Dsitearch=/usr/lib/perl5/5.38/site_perl -Dsitelib=/usr/share/perl5/site_perl -Duseshrplib -Dusethreads .; fi && \
